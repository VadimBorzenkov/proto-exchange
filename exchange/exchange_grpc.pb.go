...
// Requires gRPC-Go v1.64.0 or later.
	...
	type ExchangeServiceClient interface {
		...
		// Конвертация валюты
		ConvertCurrency(ctx context.Context, in *ExchangeRequest, opts ...grpc.CallOption) (*ExchangeResponse, error)
	}
	...
	func (c *exchangeServiceClient) ConvertCurrency(ctx context.Context, in *ExchangeRequest, opts ...grpc.CallOption) (*ExchangeResponse, error) {
		cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	type ExchangeServiceServer interface {
		...
		// Конвертация валюты
		ConvertCurrency(context.Context, *ExchangeRequest) (*ExchangeResponse, error)
	...
	func (UnimplementedExchangeServiceServer) ConvertCurrency(context.Context, *ExchangeRequest) (*ExchangeResponse, error) {
	...
	func _ExchangeService_ConvertCurrency_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
		...
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.(ExchangeServiceServer).ConvertCurrency(ctx, req.(*ExchangeRequest))
		}
		return interceptor(ctx, in, info, handler)
	}
